...
touch "$DIR_NAME/step1.cpp"
touch "$DIR_NAME/step2.cpp"
touch "$DIR_NAME/step3.cpp"
...
echo "Directory '$DIR_NAME' created with template files: step1.cpp, step2.cpp, step3.cpp, memo.md"
